...
class GameStateData(object):
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            # print("prev_state: ", prevState.agentStates)
...
class Game(object):
    ...
    def run(self, alpha_decay=0.0):
        ...
        while not self.gameOver:
            ...
            #todo: Parte para QLearning.
            # Execute the action
            VALOR_CLASE_APRENDIZAJE_REFUERZO = "<class 'bustersAgents.QLearningAgent'>"
            self.moveHistory.append((agentIndex, action))
            if self.catchExceptions:
                try:
                    previous_state = None
            ...
            """ Saves gamestate info to file -- 07/02 
            if agentIndex % numAgents == 0:
                # write file with pacman state info for ML training
                with open("./data/test_teclado_same.arff", 'a') as file:
                    if os.path.getsize(file.name) == 0:
                        # write header
                        header = "@RELATION pacman\n\n" \
                                 "@ATTRIBUTE pos_x NUMERIC\n" \
                                 "@ATTRIBUTE pos_y NUMERIC\n" \
                                 "@ATTRIBUTE ghost1_alive {0,1}\n" \
                                 "@ATTRIBUTE ghost2_alive {0,1}\n" \
                                 "@ATTRIBUTE ghost3_alive {0,1}\n" \
                                 "@ATTRIBUTE ghost4_alive {0,1}\n" \
                                 "@ATTRIBUTE ghost1_pos_x NUMERIC\n" \
                                 "@ATTRIBUTE ghost1_pos_y NUMERIC\n" \
                                 "@ATTRIBUTE ghost2_pos_x NUMERIC\n" \
                                 "@ATTRIBUTE ghost2_pos_y NUMERIC\n" \
                                 "@ATTRIBUTE ghost3_pos_x NUMERIC\n" \
                                 "@ATTRIBUTE ghost3_pos_y NUMERIC\n" \
                                 "@ATTRIBUTE ghost4_pos_x NUMERIC\n" \
                                 "@ATTRIBUTE ghost4_pos_y NUMERIC\n" \
                                 "@ATTRIBUTE distance_to_ghost1 NUMERIC\n" \
                                 "@ATTRIBUTE distance_to_ghost2 NUMERIC\n" \
                                 "@ATTRIBUTE distance_to_ghost3 NUMERIC\n" \
                                 "@ATTRIBUTE distance_to_ghost4 NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost1_x NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost1_y NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost2_x NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost2_y NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost3_x NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost3_y NUMERIC\n"\
                                 "@ATTRIBUTE relative_distance_ghost4_x NUMERIC\n" \
                                 "@ATTRIBUTE relative_distance_ghost4_y NUMERIC\n" \
                                 ...
                                 "@ATTRIBUTE chosen_move {1,2,3,4,5}\n" \
                                 "@DATA\n"
                        file.write(header)
                    file.write(self.agents[0].printLineData(observation) + "\n")
            """
            # Next agent
